...
import type { GantPaginationProps } from './interface';
...
export default memo(function GantPagination(props: GantPaginationProps) {
  ...
  useEffect(() => {
    ...
    let current = propCurrent || defaultCurrent;
  ...
  const onSwitchChange = useCallback(
    (value) => {
      ...
      !value
        ? onChange && onChange(beginIndex, pageSize, current, countLimit)
        : onChange && onChange(beginIndex, pageSize, current);
